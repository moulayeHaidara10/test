		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="{{ route('website.tag', ['slug' => $article->slug])}}"><img src="{{ $article->image }}" alt=""></a>
								<div class="post-body">
									<div class="post-category">
										<a href="category.html"> {{ $article->tag->name }} </a>
									</div>
									<h3 class="post-title"><a href="{{ route('website.tag', ['slug' => $article->slug])}}">{{ $article->titre }}</a></h3>
									<ul class="post-meta">
